...
var viewingHistory = require('./controllers/viewing_history');
...
module.exports = function(app) {
  ...
  //視聴履歴
  app.post('/api/viewing_history', isLogined, viewingHistory.create);
  app.get('/api/viewing_history/:userId/:year/:season', isLogined, viewingHistory.show);
